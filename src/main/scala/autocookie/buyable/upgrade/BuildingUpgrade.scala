...
class BuildingUpgrade(override val name: String, override protected val 
buildingRequirementsSeq: BuildingRequirement*) extends Upgrade with BuildingsRequired
